...
#define DIAG_CMD_TINNO_TEST  0x55
...
typedef enum {
  ...
  CMD_USER_WRITE_MMI,
  CMD_USER_GET_FTM_RESULT,
  CMD_USER_GET_CUSTOMER_VER,
  CMD_USER_GET_INTERNAL_VER,
...
typedef enum {
  CMD_IFFA_SOFTER_IFFA = 0x01,
  CMD_IFFA_SOFTER_SOFTER,
  CMD_IFFA_SOFTER_MAX
} CMD_IFFA_SOFTER_CMD_TYPE;
