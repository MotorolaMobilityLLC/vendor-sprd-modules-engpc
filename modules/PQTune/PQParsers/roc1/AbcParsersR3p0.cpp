...
static int parse_epf_child_config(abc_common_roc1 *abc, xmlNodePtr curNode , int epf_fun, int i)
{
	xmlNodePtr propNode;
	xmlNodePtr subNode;
	xmlChar* szPropity;
...
static int parse_epf_next_config(abc_common_roc1 *abc, xmlNodePtr curNode, int epf_fun)
{
	xmlNodePtr propNode;
	xmlNodePtr subNode;
	xmlChar* szPropity;
...
static int parse_epf_config(abc_common_roc1 *abc, xmlNodePtr curNode)
{
	xmlNodePtr tmpNode;
...
static int parse_slp_child_config(abc_common_roc1 *abc, xmlNodePtr curNode, int i)
{
	xmlNodePtr propNode;
	xmlNodePtr subNode;
	xmlChar* szPropity;
...
static int parse_slp_config(abc_common_roc1 *abc, xmlNodePtr curNode)
{
	xmlNodePtr propNode;
	xmlNodePtr subNode;
	xmlChar* szPropity;
...
static int parse_ltm_child_config(abc_common_roc1 *abc, xmlNodePtr curNode, int i)
{
	xmlNodePtr propNode;
	xmlNodePtr subNode;
	xmlChar* szPropity;
...
static int parse_ltm_config(abc_common_roc1 *abc, xmlNodePtr curNode)
{
	xmlNodePtr propNode;
	xmlNodePtr subNode;
	xmlChar* szPropity;
...
static int parse_abc_version(abc_common_roc1 *abc, xmlNodePtr curNode)
{
	xmlNodePtr subNode;
	xmlChar* szPropity;
	const char *endptr = NULL;
...
static int parse_slp_mapping_child_table(abc_common_roc1 *abc, xmlNodePtr curNode, int i)
{
	int j = 0;
	int k = 0;
	const char *endptr = NULL;
...
static int parse_slp_mapping_table(abc_common_roc1 *abc, xmlNodePtr curNode)
{
	xmlNodePtr propNode;
	xmlNodePtr subNode;
	xmlChar* szPropity;
...
static int parse_bl_mapping_table(abc_common_roc1 *abc, xmlNodePtr curNode)
{
	int i = 0;
	int j = 0;
	const char *endptr = NULL;
...
static int update_abc_version(abc_common_roc1 *abc, xmlNodePtr curNode)
{
	int i = 0;
	xmlNodePtr subNode;
	char numStr[12];
...
static int update_slp_index_xml(abc_common_roc1 *abc, xmlNodePtr curNode, int Indexnums, int i)
{
...
static int update_slp_mapping_indexs_arrays(abc_common_roc1 *abc, xmlNodePtr curNode, int i)
{
...
static int update_slp_mapping_child_table(abc_common_roc1 *abc, xmlNodePtr curNode, int i)
{
	xmlNodePtr propNode;
	xmlNodePtr subNode;
	xmlNodePtr NextpropNode;
...
static int update_slp_mapping_table(abc_common_roc1 *abc, xmlNodePtr curNode)
{
	int i = 0;
	int j = 0;
	const char *endptr = NULL;
...
static int update_bl_child_table(abc_common_roc1 *abc, xmlNodePtr curNode, int i)
{
	xmlNodePtr propNode;
	xmlNodePtr NextpropNode;
	xmlNodePtr childNode;
...
static int update_bl_mapping_table(abc_common_roc1 *abc, xmlNodePtr curNode)
{
	int i = 0;
	int j = 0;
	const char *endptr = NULL;
...
static int update_epf_config_index_xml(abc_common_roc1 *abc, xmlNodePtr curNode, int Indexnums, int i)
{
...
static int update_epf_config_indexs_arrays(abc_common_roc1 *abc, xmlNodePtr curNode, int i)
{
...
static int update_epf_child_config(abc_common_roc1 *abc, xmlNodePtr curNode, int epf_fun, int i)
{
	xmlNodePtr propNode;
	xmlNodePtr subNode;
	xmlChar* szPropity;
...
static int update_epf_next_config(abc_common_roc1 *abc, xmlNodePtr curNode, int epf_fun)
{
	int i = 0;
	int j = 0;
	const char *endptr = NULL;
...
static int update_epf_config(abc_common_roc1 *abc, xmlNodePtr curNode)
{
	xmlNodePtr tmpNode;
	xmlNodePtr subNode = curNode->children;
...
static int update_slp_child_config(abc_common_roc1 *abc, xmlNodePtr curNode, int i)
{
	xmlNodePtr propNode;
	xmlNodePtr subNode;
	xmlChar* szPropity;
...
static int update_slp_config_index_xml(abc_common_roc1 *abc, xmlNodePtr curNode, int Indexnums, int i)
{
...
static int update_slp_config_indexs_arrays(abc_common_roc1 *abc, xmlNodePtr curNode, int i)
{
...
static int update_slp_config(abc_common_roc1 *abc, xmlNodePtr curNode)
{
	int i = 0;
	int j = 0;
	const char *endptr = NULL;
...
static int update_ltm_child_config(abc_common_roc1 *abc, xmlNodePtr curNode, int i)
{
	xmlNodePtr propNode;
	xmlNodePtr subNode;
	xmlChar* szPropity;
...
static int update_ltm_config_index_xml(abc_common_roc1 *abc, xmlNodePtr curNode, int Indexnums, int i)
{
...
static int update_ltm_config_indexs_arrays(abc_common_roc1 *abc, xmlNodePtr curNode, int i)
{
...
static int update_ltm_config(abc_common_roc1 *abc, xmlNodePtr curNode)
{
	int i = 0;
	int j = 0;
	const char *endptr = NULL;
...
int AbcParserR3p0::parse_reg(uint08_t *ctx)
{
	int fd, fd1;
	uint32_t cnt;
	uint32_t sizes, sizes1;
	uint08_t* data;
	uint16_t tmp,tmp1;
	abc_common_roc1 *abc;

	abc = &((pq_tuning_parm_roc1 *)ctx)->abc;
	...
	memcpy((uint08_t*)&abc->sceneTable[0].sceneTableItem[0].slpCfg, (uint08_t*)&slp_ltm_params, tmp);
	tmp1 = sizeof(abc->sceneTable[0].sceneTableItem[0].ltmCfg);
	memcpy((uint08_t*)&abc->sceneTable[0].sceneTableItem[0].ltmCfg, (uint08_t*)&slp_ltm_params + tmp, tmp1);
	close(fd);
	close(fd1);
...
int AbcParserR3p0::update_reg(uint08_t *ctx)
{
	int fd;
	int fd1;
	char backlight[11] = {0};
	...
	if(abc->version.enable) {
		...
		tmp = sizeof(abc->sceneTable[0].sceneTableItem[0].slpCfg);
		memcpy((uint08_t*)&slp_ltm_params, (uint08_t*)&abc->sceneTable[0].sceneTableItem[0].slpCfg, tmp);
		tmp1 = sizeof(abc->sceneTable[0].sceneTableItem[0].ltmCfg);
		memcpy((uint08_t*)&slp_ltm_params + tmp, (uint08_t*)&abc->sceneTable[0].sceneTableItem[0].ltmCfg, tmp1);
		sizes = sizeof(slp_ltm_params) - 2;
		write(fd, (uint08_t *)&slp_ltm_params, sizes);
		sizes1 = sizeof(abc->sceneTable[0].sceneTableItem[0].epfCfgSunlightProtector);
		write(fd1, (uint08_t *)&abc->sceneTable[0].sceneTableItem[0].epfCfgSunlightProtector, sizes1);
		close(fd);
		close(fd1);
	}
	else {
...
int AbcParserR3p0::parse_xml(uint08_t *ctx)
{
	xmlDocPtr doc;
	xmlNodePtr curNode;
	xmlNodePtr tmpNode;
...
int AbcParserR3p0::update_xml(uint08_t *ctx)
{
	xmlDocPtr doc;
	xmlNodePtr curNode;
	xmlNodePtr tmpNode;
