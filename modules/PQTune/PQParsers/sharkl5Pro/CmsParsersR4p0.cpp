...
static int parse_hsv(cms_common_sharkl5Pro *cms, xmlNodePtr subNode, int i)
{
	xmlNodePtr propNode;
	xmlAttrPtr attrPtr;
	xmlChar* szPropity;
...
static int parse_epf(cms_common_sharkl5Pro *cms, xmlNodePtr subNode, int i)
{
	xmlNodePtr propNode;
	xmlAttrPtr attrPtr;
	xmlChar* szPropity;
...
static int parse_cm(cms_common_sharkl5Pro *cms, xmlNodePtr subNode, int i)
{
	xmlNodePtr propNode;
	xmlAttrPtr attrPtr;
	xmlChar* szPropity;
...
static int parse_slp(cms_common_sharkl5Pro *cms, xmlNodePtr subNode, int i)
{
	xmlNodePtr propNode;
	xmlAttrPtr attrPtr;
	xmlChar* szPropity;
...
static int parse_ltm(cms_common_sharkl5Pro *cms, xmlNodePtr subNode, int i)
{
	xmlNodePtr propNode;
	xmlAttrPtr attrPtr;
	xmlChar* szPropity;
...
static int parse_hsv_cm_epf_slp_ltm(cms_common_sharkl5Pro *cms, xmlNodePtr subNode, int i)
{
	xmlNodePtr propNode;
	xmlNodePtr curNode;
	xmlAttrPtr attrPtr;
...
static int parse_cms_version(cms_common_sharkl5Pro *cms, xmlNodePtr curNode)
{
	xmlNodePtr subNode;
	xmlChar* szPropity;
...
static int parse_cms_hsvcm_epf_slp_ltm(cms_common_sharkl5Pro *cms, xmlNodePtr curNode)
{
	const char *endptr = NULL;
	xmlNodePtr subNode;
	xmlNodePtr propNode;
...
static int parse_cms_sat(cms_common_sharkl5Pro *cms, xmlNodePtr subNode)
{
	xmlNodePtr propNode;
	xmlAttrPtr attrPtr;
	xmlChar* szPropity;
...
static int parse_cms_rgbmap_table(cms_common_sharkl5Pro *cms, xmlNodePtr curNode)
{
	int i = 0;
	int j = 0;
	const char *endptr = NULL;
...
static int parse_cms_config_table(cms_common_sharkl5Pro *cms, xmlNodePtr curNode)
{
	int i = 0;
	const char *endptr = NULL;
	xmlNodePtr subNode;
...
static int update_cms_sat_config(cms_common_sharkl5Pro *cms, xmlNodePtr curNode)
{
	xmlNodePtr propNode;
	xmlAttrPtr attrPtr;
	xmlChar* szPropity;
...
static int update_cms_version(cms_common_sharkl5Pro *cms, xmlNodePtr curNode)
{
    int i = 0;
    xmlNodePtr subNode;
    char numStr[12];
...
static int update_hsv(cms_common_sharkl5Pro *cms, xmlNodePtr subNode, int i)
{
	xmlNodePtr propNode;
	xmlAttrPtr attrPtr;
	xmlChar* szPropity;
...
static int update_cm(cms_common_sharkl5Pro *cms, xmlNodePtr subNode, int i)
{
	xmlNodePtr propNode;
	xmlAttrPtr attrPtr;
	xmlChar* szPropity;
...
static int update_epf(cms_common_sharkl5Pro *cms, xmlNodePtr subNode, int i)
{
	xmlNodePtr propNode;
	xmlAttrPtr attrPtr;
	xmlChar* szPropity;
...
static int update_slp(cms_common_sharkl5Pro *cms, xmlNodePtr subNode, int i)
{
	xmlNodePtr propNode;
	xmlAttrPtr attrPtr;
	xmlChar* szPropity;
...
static int update_ltm(cms_common_sharkl5Pro *cms, xmlNodePtr subNode, int i)
{
	xmlNodePtr propNode;
	xmlAttrPtr attrPtr;
	xmlChar* szPropity;
...
static int update_hsv_cm_epf_slp_ltm(cms_common_sharkl5Pro *cms, xmlNodePtr curNode, int i)
{
...
static int update_cms_hsv_cm_epf_slp_ltm(cms_common_sharkl5Pro *cms, xmlNodePtr curNode)
{
	const char *endptr = NULL;
	xmlNodePtr subNode;
	xmlNodePtr propNode;
...
static int update_cms_rgbmap_table(cms_common_sharkl5Pro *cms, xmlNodePtr curNode)
{
	int i = 0;
	int j = 0;
	const char *endptr = NULL;
...
static int update_cms_config_table(cms_common_sharkl5Pro *cms, xmlNodePtr curNode)
{
	int i = 0;
	const char *endptr = NULL;
	xmlNodePtr subNode;
...
int CmsParserR4p0::update_xml(uint08_t *ctx)
{
	xmlDocPtr doc;
	xmlNodePtr curNode;
	xmlNodePtr tmpNode;
...
int CmsParserR4p0::parse_xml(uint08_t *ctx)
{
	xmlDocPtr doc;
	xmlNodePtr curNode;
	xmlNodePtr tmpNode;
