...
int parse_lite_r2p0_gamma_reg(struct gamma_common *gamma)
{
	int fd;
	u32 sizes;
	u8* data;
...
int update_lite_r2p0_gamma_reg(struct gamma_common *gamma)
{
	int fd;
	int fd1;
	u32 sizes;
...
int parse_lite_r2p0_abc_reg(struct abc_common *abc)
{
	int fd;
	u32 cnt;
	u32 sizes;
...
int update_lite_r2p0_abc_reg(struct abc_common *abc)
{
	int fd;
	int fd1;
	char backlight[11] = {0};
...
int parse_lite_r2p0_cms_reg(struct cms_common *cms)
{
	int fd0, fd1;
	u32 sizes0,sizes1;
	u8* data;
...
int update_lite_r2p0_cms_reg(struct cms_common *cms)
{
	int fd0, fd1, fd2;
	u32 sizes0,sizes1;
	u8* data;
...
int parse_lite_r2p0_bld_reg(struct bld_common *bld)
{
	int fd0, fd1;
	u32 cnt0,cnt1;
	u32 sizes0,sizes1;
...
int update_lite_r2p0_bld_reg(struct bld_common *bld)
{
	int fd0, fd1, fd2;
	u32 sizes0,sizes1;
	u8* data;
